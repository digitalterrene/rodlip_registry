...
export default function Registries({ registry }) {
  let title = registry.replaceAll("_", " ");
  ...
  const handleSearch = async () => {
    const response = await fetch(
      `https://server.entities.vertueal.com/entities/search_entities/${"registry"}`,
      {
        method: "POST",
        body: JSON.stringify({ key_value: registry }),
        headers: {
